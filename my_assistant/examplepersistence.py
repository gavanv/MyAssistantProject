...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if context.user_data:
        reply_text += (
            f" You already told me your {
                ', '.join(context.user_data.keys())}. Why don't you "
...
async def done(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    await update.message.reply_text(
        f"I learned these facts about you: {
            facts_to_str(context.user_data)}Until next time!",
...
def main() -> None:
    ...
    application = Application.builder().token(
        "6468413070:AAH2MqghzbnZiBG4Dx-l7DpqD6qBTEExuEw").persistence(persistence).build()
